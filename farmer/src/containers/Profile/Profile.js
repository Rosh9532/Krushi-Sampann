        ...
        <Container className="mbod" fluid>
            ...
            <div className="infobody">
                ...
                {/* <Row className="grp">
                    ...
                    {auth.user.Address.address} {auth.user.Address.city} {auth.user.Address.postalCode}
            </Col>
                </Row>
                ...
                <Row className="grp">
                    ...
                    <Col lg={6}>{auth.user.Address.district}</Col>
                </Row> */}
                <hr />
                <br />
                <Row>
                    <Col lg={10} xs={5}>
                        ...
                        >
                           <Link to ='/' className ="btnLink">Back</Link>
              </Button>
                    </Col>
                    <Col lg={2} xs={7}>
                        <Button
                        ...
                        >
                         <Link className ="btnLink" to ="/products">My Products</Link>
              </Button>
                    </Col>
                </Row>
            </div>
